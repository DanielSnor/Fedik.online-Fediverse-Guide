...
#
# Test:
#   1. POST nahraje testovací soubor (fedik_test.txt)
...
TEST_NAME = "fedik_test.txt"
TEST_BODY = "Fedík Surfer test #{Time.now.utc.iso8601}\n"
...
post["User-Agent"] = "fedik-test/1.0"
post.body = body
begin
...
puts "------------------------------------------------------------"
puts "✅ Surfer Files API funguje. deploy_web.rb bude moci uploadovat."
