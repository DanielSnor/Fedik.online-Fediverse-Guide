...
(function () {
  ...
  var APPS = {
    ...
    mbin:        { id: 'mbin',        name: 'Mbin',        contentType: 'forum',      centralizedEquivalent: 'Reddit',               joinUrl: 'https://joinmbin.org', internalUrl: '#view=instance&iapp=mbin' },
    ...
    loops:       { id: 'loops',       name: 'Loops',       contentType: 'shortvideo', centralizedEquivalent: 'TikTok',               joinUrl: 'https://loops.video', internalUrl: '#view=instance&iapp=loops' },
    bookwyrm:    { id: 'bookwyrm',    name: 'BookWyrm',    contentType: 'books',      centralizedEquivalent: 'Goodreads',            joinUrl: 'https://joinbookwyrm.com', internalUrl: '#view=instance&iapp=bookwyrm' },
    funkwhale:   { id: 'funkwhale',   name: 'Funkwhale',   contentType: 'music',      centralizedEquivalent: 'Spotify / SoundCloud', joinUrl: 'https://funkwhale.audio', internalUrl: '#view=instance&iapp=funkwhale' },
    mobilizon:   { id: 'mobilizon',   name: 'Mobilizon',   contentType: 'events',     centralizedEquivalent: 'Facebook Events',      joinUrl: 'https://joinmobilizon.org', internalUrl: '#view=instance&iapp=mobilizon' },
    writefreely: { id: 'writefreely', name: 'WriteFreely', contentType: 'blog',       centralizedEquivalent: 'Medium',               joinUrl: 'https://writefreely.org', internalUrl: '#view=instance&iapp=writefreely' },
