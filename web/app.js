...
(function () {
  ...
  var STRINGS = {
    cs: {
      ...
      brand_prefix: 'Fedík',
      brand_domain: '',
      title_doc: 'Fedík.online — Průvodce Fediverse',
      ...
      nav_charts: 'Žebříčky',
      nav_risers: 'Skokani týdne',
      nav_new: 'Novinky',
      nav_all: 'Vše',
      nav_top10_foll: 'Top 10 sledovaných',
      nav_top10_active: 'Top 10 aktivních',
      nav_top50_foll: 'Top 50 sledovaných',
      nav_top50_active: 'Top 50 aktivních',
      nav_risers_foll: 'V sledujících',
      nav_risers_active: 'V aktivitě',
      nav_recent: 'Nedávno přidané',
      filters_toggle: 'Filtry',
      menu_show: 'Menu',
      menu_hide: 'Zavřít',
      head_topic_byaccount: 'Oblast (dle účtu)',
      count_of: 'z',
      count_sources: 'zdrojů',
      // ─── Hledání / řazení / filtry (katalog účtů) ───
      search_label: 'Vyhledat',
      search_ph: 'Jméno nebo handle…',
      sort_label: 'Řadit',
      sort_name: 'Abecedně',
      sort_followers: 'Nejvíc sledujících',
      sort_posts: 'Nejaktivnější',
      sort_added: 'Nejnověji přidané',
      head_topic: 'Oblast',
      head_type: 'Typ účtu',
      head_language: 'Jazyk',
      head_tag: 'Tag',
      tag_ph: 'Filtr podle tagu…',
      reset: 'Zrušit filtry',
      // ─── Stav / načítání / chyby / patička ───
      loading: 'Načítám katalog…',
      empty_title: 'Žádný zdroj neodpovídá filtrům.',
      empty_hint: 'Zkus uvolnit některý z filtrů.',
      empty_reset: 'Reset filtrů',
      ...
      footer_updates_stats: 'statistiky',
      footer_updates_apps: 'aplikace',
      footer_updates_instances: 'instance',
      footer_updates_tools: 'nástroje',
      footer_sponsor: 'Tento web běží\ndíky podpoře',
      footer_owner: 'Jsi vlastník účtu a chceš jej z katalogu odstranit? Napiš na',
      // ─── Katalog účtů — rodiny/typy/jazyky/staty/modal/slice/top ───
      hover_source: 'Zdroj: ',
      card_detail: 'Detail ',
      label_bot: 'Automat',
      label_bot_title: 'Automatizovaný účet (bot)',
      profile_title: 'Otevřít profil',
      fam_sport: 'Sport',
      fam_news: 'Zprávy',
      fam_culture: 'Kultura',
      fam_science_tech: 'Věda & technika',
      fam_lifestyle: 'Životní styl',
      fam_business: 'Byznys',
      fam_humor: 'Humor',
      fam_government: 'Stát',
      type_person: 'Osoba',
      type_media: 'Médium',
      type_institution: 'Organizace',
      type_institution_formal: 'Instituce',
      type_institution_filter: 'Instituce/Organizace',
      type_team: 'Tým',
      type_other: 'Ostatní',
      lang_cs: 'Čeština',
      lang_sk: 'Slovenčina',
      lang_en: 'English',
      stat_followers: 'sledujících',
      stat_posts_week: 'příspěvků/týden',
      stat_language: 'jazyk',
      modal_sources: 'Původní profily',
      modal_open: 'Otevřít profil',
      modal_follow: 'Sledovat',
      modal_follow_title: 'Otevře profil, kde můžeš sledovat ze své Mastodon instance',
      modal_close: 'Zavřít',
      slice_platform: 'Zdroje s platformou ',
      slice_recent_pre: 'Přidané za posledních ',
      slice_recent_post: ' dní',
      slice_top_pre: 'Top ',
      slice_top_post: ' (ostatní filtry kromě oblasti jsou vypnuté)',
      top_phrase_followers: 'podle sledujících',
      top_phrase_active: 'podle aktivity',
      top_phrase_gain_followers: 'podle nárůstu sledujících',
      top_phrase_gain_activity: 'podle nárůstu aktivity',
      // ─── Začínáme — rozcestník ───
      ...
      // ─── Začínáme — sidebar menu, kroky (labels/desc/intro) ───
      ...
      // ─── Začínáme — krok 2 (výběr aplikace / picker) ───
      ...
      // ─── Začínáme — krok 5 (první den + normy) ───
      ...
      fday_1: 'Vyplň profil — avatar (profilový obrázek), krátké bio (pár vět o sobě) a hlavičku (banner nahoře na profilu). Účty, co nevypadají prázdně, lidi spíš sledují.',
      fday_2: 'Ověř svůj web odkazem <button class="glossary-term" data-glossary="overeni-profilu">rel=me</button> — u profilu pak svítí, že je doopravdy tvůj.',
      ...
      // ─── Začínáme — krok 6 (najdi lidi) + crew ───
      ...
      // ─── Začínáme — navigace „další krok" ───
      start_next_step: 'Další krok',
      start_next_2: 'Další krok: Výběr aplikace',
      start_next_3: 'Další krok: Výběr instance',
      start_next_4: 'Další krok: Založení účtu',
      start_next_5: 'Další krok: První den',
      start_next_6: 'Další krok: Hledání lidí',
      // ─── Úvody pohledů (cat_* hero) ───
      cat_apps_head: 'Aplikace — vyber si loď',
      cat_apps_p1: 'Aplikace jsou lodě Fediverse — software, kterým do něj vstoupíš. Každá se hodí na něco jiného: mikroblog, fotky, video, fórum, blog. Všechny si ale spolu umí povídat, takže ať si vybereš kteroukoliv, pořád jsi na jedné síti.',
      cat_apps_p2: 'Najdeš tu přehled aplikací s informací o tom, čemu se podobají v běžných sítích, s počtem uživatelů a instancí a zda mají české rozhraní. Údaje o velikosti jsou orientační z FediDB. Filtruj podle typu obsahu, obdoby známé sítě nebo češtiny v rozhraní.',
      cat_instances_head: 'Instance — najdi si planetu',
      cat_instances_p1: 'Instance jsou planety, na kterých můžeš přistát — servery, kde si založíš účet. Liší se velikostí, zaměřením i náladou, ale všechny patří do jednoho Fediverse, takže odkudkoli dosáhneš na kohokoli.',
      cat_instances_p2: 'Najdeš tu české a slovenské instance z katalogu Sloník.online — u každé velikost, aktivitu, stav registrace a počet účtů, které jsou v katalogu. Instance jsou seřazeny podle počtu aktivních uživatelů. Můžeš filtrovat podle aplikace, regionu a zaměření. Filtr "Pro začátečníky" zobrazí prověřené instance.',
      cat_tools_head: 'Nástroje — vybav si základnu',
      cat_tools_p1: 'Nástroje jsou palubní vybavení fedinauta — klienti do telefonu, mosty mezi sítěmi, objevovače účtů, crosspostery a další pomocníci, kteří ti cestu zpříjemní. Tvoje aplikace funguje i bez nich, ale s nimi je pohodlnější.',
      cat_tools_p2: 'Klienti jsou z FediDB, zbytek je pečlivě připravený výběr živých nástrojů. Můžeš filtrovat podle kategorie (klient, most, migrace, RSS, …), platformy (Android, iOS, web, desktop), ceny, ale hlavně podle aplikace — ať vidíš jen to, co se hodí k tvé síti.',
      cat_glossary_head: 'Slovníček — palubní příručka',
      cat_glossary_p1: 'Slovníček je palubní příručka — Fediverse má vlastní nářečí (instance, federace, boost, CW…) a první týden v něm zní leccos cize. Tady si kterýkoli výraz v klidu dohledáš.',
      cat_glossary_p2: 'Najdeš tu hesla od základních pojmů až po praktické postupy vysvětlená česky a bez žargonu. Hledej podle názvu, nebo proklikni některý z výrazů v průvodci, který na Slovníček odkazuje.',
      cat_stats_head: 'Statistiky — pohled z oběžné dráhy',
      cat_stats_p1: 'Statistiky jsou pohled z oběžné dráhy — Fediverse i tenhle katalog v číslech. Kolik je aplikací, instancí a nástrojů a jak se v čase proměňují.',
      ...
      // ─── Pohled: Aplikace (filtry, karty, řazení) ───
      common_yes: 'Ano',
      common_no: 'Ne',
      ...
      apps_head_type: 'Typ obsahu',
      apps_head_equiv: 'Obdoba sítě',
      apps_head_czech: 'Čeština v rozhraní',
      apps_head_advanced: 'Pokročilé filtry',
      apps_head_managed: 'Managed hosting',
      apps_head_devstatus: 'Stav vývoje',
      asort_users: 'Nejvíc uživatelů',
      asort_instances: 'Nejvíc instancí',
      apps_tab_risers: 'Nejrychleji rostoucí',
      apps_tab_new: 'Nové projekty',
      apps_growth_week: '/ týden',
      apps_count: 'aplikací',
      apps_empty: 'Žádná aplikace neodpovídá filtrům.',
      apps_updated: 'aktualizováno',
      apps_like: 'jako',
      apps_czech_label: 'Čeština',
      apps_users: 'uživatelů',
      apps_instances: 'instancí',
      apps_stat_note: 'orientační (FediDB)',
      apps_managed_yes: 'managed hosting',
      apps_link_join: 'Připojit se',
      apps_link_web: 'Web',
      apps_link_src: 'Zdroják',
      czui_ano: 'Ano',
      czui_castecne: 'Částečně',
      czui_ne: 'Ne',
      czui_unknown: 'Neznámo',
      dev_aktivni: 'Aktivní',
      dev_zraly: 'Zralý',
      dev_experimentalni: 'Experimentální',
      dev_utlumeny: 'Útlumený',
      dev_unknown: 'Neznámo',
      // ─── Pohled: Instance ───
      ...
      instance_loading: 'Načítám instance…',
      instance_unavail: 'Seznam instancí zatím není k dispozici.',
      instance_count: 'instancí',
      instance_reg_open: 'Registrace otevřené',
      instance_reg_approval: 'Registrace se schválením',
      ...
      instance_sec_global: 'Globální doporučené',
      instance_search_ph: 'Název nebo doména…',
      isort_users: 'Nejvíc uživatelů',
      isort_reg: 'Podle registrace',
      instance_region_head: 'Region',
      instance_head_app: 'Aplikace',
      instance_head_focus: 'Zaměření',
      instance_head_reg: 'Registrace',
      instance_head_size: 'Velikost',
      instance_region_cz: 'Česko',
      instance_region_sk: 'Slovensko',
      instance_region_global: 'Globální',
      instance_beginner: 'Pro začátečníky',
      ifoc_obecna: 'Obecná',
      ifoc_tech: 'Tech',
      ifoc_umeni: 'Umění',
      ifoc_akademicka: 'Akademická',
      ifoc_hry: 'Hry',
      ifoc_region: 'Region',
      ifoc_lgbtq: 'LGBTQ+',
      isize_small: 'Malá (<1k)',
      isize_medium: 'Střední',
      isize_large: 'Velká',
      irank_activity: 'Aktivita instance',
      irank_ratio: 'Poměrem',
      irank_volume: 'Objemem',
      irank_ratio_note: 'podle podílu aktivních uživatelů',
      irank_volume_note: 'podle celkového počtu příspěvků',
      // ─── Pohled: Nástroje ───
      tools_nav_desc: 'Klienti, mosty, nástroje pro objevování účtů a další nástroje pro Fediverse. Můžeš filtrovat podle kategorie, platformy, aplikace a ceny. Klienti jsou z FediDB, zbytek jsou vybrané aktuální nástroje.',
      tools_head_category: 'Kategorie',
      tools_head_platform: 'Platforma',
      tools_head_forapp: 'Pro aplikaci',
      tools_head_price: 'Cena',
      tcat_klient: 'Klient',
      tcat_crossposter: 'Crossposter',
      tcat_most: 'Most (bridge)',
      tcat_objevovani: 'Objevování účtů',
      tcat_migrace: 'Migrace',
      tcat_rss: 'RSS / automatizace',
      tcat_analytika: 'Analytika',
      tplat_android: 'Android',
      tplat_ios: 'iOS',
      tplat_web: 'Web',
      tplat_desktop: 'Desktop',
      tplat_sluzba: 'Web/služba',
      tprice_zdarma: 'Zdarma',
      tprice_freemium: 'Freemium',
      tprice_placene: 'Placené',
      tprice_unknown: 'neuvedeno',
      tools_count: 'nástrojů',
      tools_tab_featured: 'Doporučené',
      tools_tab_new: 'Nově přidané',
      tools_own: 'náš projekt',
      tools_official: 'oficiální',
      tools_featured: 'doporučené',
      tools_for: 'Pro:',
      tools_added: 'přidáno',
      tools_link_open: 'Otevřít ↗',
      tools_link_appstore: 'App Store ↗',
      tools_link_googleplay: 'Google Play ↗',
      tools_link_fdroid: 'F-Droid ↗',
      tools_link_src: 'Zdroják ↗',
      tools_glossary: 'Slovníček →',
      ...
      gloss_more: 'Více ve Slovníčku →',
      gloss_aria: 'Vysvětlit pojem: %s',
      ...
      gloss_head_level: 'Úroveň',
      gloss_head_theme: 'Téma',
      gloss_head_type: 'Typ',
      gsort_order: 'Pro začátečníky',
      gsort_alpha: 'Abecedně',
      gsort_theme: 'Tematicky',
      glevel_zakladni: 'Základní',
      glevel_pokrocile: 'Pokročilé',
      gtype_pojem: 'Pojem',
      gtype_postup: 'Postup',
      gtype_zkratka: 'Zkratka',
      gtheme_ucty: 'Účty',
      gtheme_federace: 'Federace',
      gtheme_obsah: 'Obsah',
      gtheme_moderovani: 'Moderování',
      gtheme_soukromi: 'Soukromí',
      gtheme_technika: 'Technika',
      gloss_count: 'hesel',
      gloss_unit: 'hesel',
      gloss_empty: 'Žádné heslo neodpovídá filtrům.',
      gloss_steps: 'Postup krok za krokem',
      gloss_seealso: 'Souvisí',
      gloss_external: 'Oficiální návod ↗',
      gloss_no_steps: 'Klikací kroky doplníme; podstata je v popisu výše.',
      // ─── Pohled: Statistiky ───
      ...
      stats_head_period: 'Období',
      stats_head_region: 'Region',
      stats_head_series: 'Aplikace (řady)',
      stats_tab_overview: 'Přehled',
      stats_tab_apps: 'Podle aplikací',
      stats_tab_growth: 'Růst v čase',
      stats_tab_czsk: 'CZ/SK výřez',
      stats_users: 'Uživatelé',
      stats_mau: 'Měsíčně aktivní',
      stats_servers: 'Servery',
      stats_posts: 'Příspěvky',
      stats_czsk_instances: 'CZ/SK instance',
      stats_total: 'Celá síť',
      stats_region_global: 'Globální',
      stats_region_czsk: 'CZ-SK',
      stats_period_1y: '1 rok',
      stats_period_2y: '2 roky',
      stats_period_all: 'Vše',
      ...
      ltype_navod: 'Návod',
      ltype_clanek: 'Článek',
      ltype_oficialni: 'Oficiální stránka',
      ltype_video: 'Video',
      links_head_lang: 'Jazyk',
      links_head_theme: 'Téma',
      ltheme_uvod: 'Úvod',
      ltheme_navody: 'Návody',
      ltheme_technika: 'Technika',
      ltheme_komunita: 'Komunita',
      ltheme_data: 'Data',
      lsort_recommended: 'Doporučené',
      lsort_alpha: 'Abecedně',
      lsort_lang: 'Podle jazyka',
      lfresh_undated: 'bez data',
      ...
      search_unit_accounts: 'účtů',
      search_unit_posts: 'postů',
      search_sec_accounts: 'Účty',
      search_sec_posts: 'Posty',
      search_loading: 'Načítám index…',
      search_hint: 'zadej dotaz',
      search_zero: 'Nic nenalezeno. Zkus jiná / obecnější slova.',
      search_results_unit: 'výsledků',
      search_unavail: 'Vyhledávací index zatím není k dispozici.',
      search_open: 'otevřít na Mastodonu',
      search_posts_active: 'příspěvků (30 dní)',
      search_followers: 'sledujících',
      ...
      about_menu_howto: 'Jak pracovat',
      about_menu_other: 'Ostatní',
      ...
      about_nav_about: 'O Fedíku',
      about_nav_search: 'Vyhledáváním',
      about_nav_instance: 'Instancemi',
      about_nav_apps: 'Aplikacemi',
      about_nav_tools: 'Nástroji',
      about_nav_accounts: 'Účty',
      about_nav_posts: 'Posty',
      about_nav_links_howto: 'Odkazy',
      about_nav_tech: 'Technické řešení',
      about_nav_author: 'O autorovi',
      about_nav_faq: 'FAQ',
      about_nav_faq_novacci: 'Pro začátečníky',
      about_nav_stats: 'Statistikami',
      // ─── O Fedíku — Pro začátečníky (FAQ + tipy) ───
      faqn_head: 'Pro začátečníky',
      faqn_q_head: 'Časté otázky',
      faqn_tips_head: 'Tipy pro Mastodon',
      tip1_t: 'Hlídej si jazyk příspěvku',
      tip1_d: 'Mastodon u každého tootu nastavuje jazyk. Český příspěvek omylem poslaný jako anglický se neobjeví v české federované ose (a naopak) — před odesláním zkontroluj.',
      tip2_t: 'Vyplň profil hned na začátku',
      tip2_d: 'Avatar, krátké bio a pár prvních příspěvků. Prázdné účty vypadají neaktivně nebo jako spam — lidi je nesledují a správci je občas promazávají.',
      tip3_t: 'Citování místo boostu',
      tip3_d: 'Mastodon historicky neměl nativní citace (quote posts), takže se používal workaround s novým příspěvkem a odkazem. V novějších verzích (např. 4.5) už ale citace existují – pokud je instance a autor povolí.',
      tip4_t: 'Číst jde i bez účtu',
      tip4_d: 'Nechceš se registrovat a jen sledovat? K profilu přidej .rss (https://server/@jméno.rss) a vlož do RSS čtečky.',
      tip5_t: 'Ztlum, ať máš klid',
      tip5_d: 'Zahlcená osa? Ztlum účty nebo hashtagy, které tě nezajímají (mute) — federovaná i domácí osa jsou pak hned čitelnější.',
      tip6_t: 'Seznamy na úklid domácí osy',
      tip6_d: 'Roztřiď sledované do seznamů a ty nedůležité skryj z domácí osy („Skrýt členy na domovském kanálu“). Specifická témata — sport, hudbu — pak čteš, když chceš.',
      tip7_t: 'Pozor na editaci ankety',
      tip7_d: 'Když upravíš už běžící anketu, vynuluje se a poběží od začátku. Před odesláním ji proto pečlivě zkontroluj.',
      tip8_t: 'Přizpůsob si vzhled',
      tip8_d: 'Nelíbí se ti webový klient? Zkus alternativní (Elk, Phanpy) nebo do prohlížeče přidej rozšíření Stylish a téma TangerineUI.',
      faqn_q1: 'Registrace čeká na schválení — co teď?',
      faqn_a1: 'U serverů „po schválení“ tě musí ověřit správce. Většinou to trvá pár hodin, někdy do druhého dne. Přijde ti e-mail. Zatím můžeš v klidu projít zbytek tipů tady.',
      ...
      faqn_a3: 'Mastodon to má přímo vestavěné: na novém účtu nastavíš alias na starý, na starém spustíš přesun a sledující se přenesou automaticky. Příspěvky se nepřenášejí, profil a sledující ano.',
    ...
    en: {
      ...
      brand_prefix: 'Fedík',
      brand_domain: '',
      title_doc: 'Fedík.online — Fediverse guide',
      claim: 'Your guide to the Fediverse',
      // ─── Názvy pohledů (view_*) ───
      view_start: 'Start here',
      view_apps: 'Apps',
      view_instance: 'Instances',
      view_tools: 'Tools',
      ...
      nav_charts: 'Charts',
      nav_risers: 'Weekly risers',
      nav_new: 'New',
      nav_all: 'All',
      nav_top10_foll: 'Top 10 followed',
      nav_top10_active: 'Top 10 active',
      nav_top50_foll: 'Top 50 followed',
      nav_top50_active: 'Top 50 active',
      nav_risers_foll: 'In followers',
      nav_risers_active: 'In activity',
      nav_recent: 'Recently added',
      filters_toggle: 'Filters',
      menu_show: 'Menu',
      menu_hide: 'Close',
      head_topic_byaccount: 'Topic (by account)',
      count_of: 'of',
      count_sources: 'sources',
      // ─── Hledání / řazení / filtry (katalog účtů) ───
      search_label: 'Search',
      search_ph: 'Name or handle…',
      sort_label: 'Sort',
      sort_name: 'Alphabetically',
      sort_followers: 'Most followers',
      sort_posts: 'Most active',
      sort_added: 'Recently added',
      head_topic: 'Topic',
      head_type: 'Account type',
      head_language: 'Language',
      head_tag: 'Tag',
      tag_ph: 'Filter by tag…',
      reset: 'Clear filters',
      // ─── Stav / načítání / chyby / patička ───
      loading: 'Loading catalog…',
      empty_title: 'No source matches the filters.',
      empty_hint: 'Try loosening one of the filters.',
      ...
      footer_updates_stats: 'statistics',
      footer_updates_apps: 'apps',
      footer_updates_instances: 'instances',
      footer_updates_tools: 'tools',
      footer_sponsor: 'This site runs\nwith support from',
      footer_owner: 'Are you the owner and want it removed from the catalog? Write to',
      // ─── Katalog účtů — rodiny/typy/jazyky/staty/modal/slice/top ───
      hover_source: 'Source: ',
      card_detail: 'Detail of ',
      label_bot: 'Bot',
      label_bot_title: 'Automated account (bot)',
      profile_title: 'Open profile',
      fam_sport: 'Sports',
      fam_news: 'News',
      fam_culture: 'Culture',
      fam_science_tech: 'Science & tech',
      fam_lifestyle: 'Lifestyle',
      fam_business: 'Business',
      fam_humor: 'Humor',
      fam_government: 'Government',
      type_person: 'Person',
      type_media: 'Media',
      type_institution: 'Organization',
      type_institution_formal: 'Institution',
      type_institution_filter: 'Institution/Organization',
      type_team: 'Team',
      type_other: 'Other',
      lang_cs: 'Czech',
      lang_sk: 'Slovak',
      ...
      stat_posts_week: 'posts/week',
      stat_language: 'language',
      modal_sources: 'Original profiles',
      modal_open: 'Open profile',
      modal_follow: 'Follow',
      modal_follow_title: 'Opens the profile where you can follow from your own Mastodon instance',
      modal_close: 'Close',
      slice_platform: 'Sources on ',
      slice_recent_pre: 'Added in the last ',
      slice_recent_post: ' days',
      slice_top_pre: 'Top ',
      slice_top_post: ' (filters except topic are off)',
      top_phrase_followers: 'by followers',
      top_phrase_active: 'by activity',
      top_phrase_gain_followers: 'by follower growth',
      top_phrase_gain_activity: 'by activity growth',
      // ─── Začínáme — rozcestník ───
      ...
      fday_1: 'Fill in your profile — an avatar (profile picture), a short bio (a few words about you) and a header (the banner at the top). People follow accounts that don’t look empty.',
      fday_2: 'Verify your website with a <button class="glossary-term" data-glossary="overeni-profilu">rel=me</button> link — your profile then shows the site is really yours.',
      ...
      start_next_2: 'Next step: Choose an app',
      start_next_3: 'Next step: Choose an instance',
      start_next_4: 'Next step: Create an account',
      start_next_5: 'Next step: Day one',
      start_next_6: 'Next step: Find people',
      // ─── Úvody pohledů (cat_* hero) ───
      cat_apps_head: 'Apps — pick your ship',
      cat_apps_p1: 'Apps are the ships of the Fediverse — the software you enter it through. Each is good at something different: microblogging, photos, video, forums, blogs. They all talk to each other, so whatever you pick, you’re never cut off from the network.',
      cat_apps_p2: 'Here you’ll find an overview of apps with their everyday-network equivalents, user and instance counts, and whether they have a Czech interface. Size data is indicative, from FediDB. Filter by content type, familiar-network equivalent, or Czech UI.',
      cat_instances_head: 'Instances — find your planet',
      cat_instances_p1: 'Instances are the planets you can land on — the servers where you create your account. They differ in size, focus and mood, but all belong to one Fediverse, so from anywhere you can reach anyone.',
      cat_instances_p2: 'We show Czech and Slovak Mastodon instances from the Sloník.online catalog — each with size, activity, registration status and how many of its accounts are in the catalog. Sorted by share of active users; filter by Top 10/50, by ratio or volume, and check the “for beginners” ranking.',
      cat_tools_head: 'Tools — kit out your base',
      cat_tools_p1: 'Tools are a fedinaut’s onboard kit — phone clients, bridges between networks, account discoverers, crossposters and other helpers that make the trip smoother. Your app works without them, but they make it comfier.',
      cat_tools_p2: 'Clients come from FediDB, the rest is a curated pick of live tools. Filter by category (client, bridge, migration, RSS…), platform (Android, iOS, web, desktop), price, and above all by app — so you only see what fits your network.',
      cat_glossary_head: 'Glossary — onboard handbook',
      cat_glossary_p1: 'The glossary is your onboard handbook — the Fediverse has its own dialect (instance, federation, boost, CW…), and the first week a lot of it sounds foreign. Here you can look any term up in peace.',
      cat_glossary_p2: 'You’ll find entries from basic concepts to practical how-tos, explained in plain language. Search by name, or follow the links from terms in the guide that point here.',
      cat_stats_head: 'Statistics — the view from orbit',
      cat_stats_p1: 'Statistics are the view from orbit — the Fediverse and this catalog in numbers. How many apps, instances and tools there are, and how it shifts over time.',
      cat_stats_p2: 'The numbers come from the data Fedík is built on (FediDB, Sloník.online and curated lists), with a last-updated date on each set. Treat them as indicative — the Fediverse changes every day.',
      cat_links_head: 'Links — beacons further out',
      cat_links_p1: 'Links are beacons further out — for when Fedík isn’t enough and you want to read more, follow what’s happening, or get involved deeper. A signpost beyond this guide.',
      cat_links_p2: 'A curated pick of Czech and international resources about the Fediverse: sites, blogs, communities and other guides. We list only live, worthwhile links, not everything that exists.',
      // ─── Pohled: Aplikace (filtry, karty, řazení) ───
      common_yes: 'Yes',
      common_no: 'No',
      ...
      apps_head_type: 'Content type',
      apps_head_equiv: 'Centralized analog',
      apps_head_czech: 'Czech UI',
      apps_head_advanced: 'Advanced filters',
      apps_head_managed: 'Managed hosting',
      apps_head_devstatus: 'Dev status',
      asort_users: 'Most users',
      asort_instances: 'Most instances',
      apps_tab_risers: 'Fastest growing',
      apps_tab_new: 'New projects',
      apps_growth_week: '/ week',
      apps_count: 'apps',
      apps_empty: 'No app matches the filters.',
      apps_updated: 'updated',
      apps_like: 'like',
      apps_czech_label: 'Czech',
      apps_users: 'users',
      apps_instances: 'instances',
      apps_stat_note: 'approx. (FediDB)',
      apps_managed_yes: 'managed hosting',
      apps_link_join: 'Join',
      apps_link_web: 'Web',
      apps_link_src: 'Source',
      czui_ano: 'Yes',
      czui_castecne: 'Partial',
      czui_ne: 'No',
      czui_unknown: 'Unknown',
      dev_aktivni: 'Active',
      dev_zraly: 'Mature',
      dev_experimentalni: 'Experimental',
      dev_utlumeny: 'Dormant',
      dev_unknown: 'Unknown',
      // ─── Pohled: Instance ───
      ...
      instance_loading: 'Loading instances…',
      instance_unavail: 'Instance list is not available yet.',
      instance_count: 'instances',
      instance_reg_open: 'Registrations open',
      instance_reg_approval: 'Registrations with approval',
      ...
      instance_sec_global: 'Recommended global',
      instance_search_ph: 'Name or domain…',
      isort_users: 'Most users',
      isort_reg: 'By registration',
      instance_region_head: 'Region',
      instance_head_app: 'App',
      instance_head_focus: 'Focus',
      instance_head_reg: 'Registration',
      instance_head_size: 'Size',
      instance_region_cz: 'Czechia',
      instance_region_sk: 'Slovakia',
      instance_region_global: 'Global',
      instance_beginner: 'Beginner-friendly',
      ifoc_obecna: 'General',
      ifoc_tech: 'Tech',
      ifoc_umeni: 'Art',
      ifoc_akademicka: 'Academia',
      ifoc_hry: 'Games',
      ifoc_region: 'Regional',
      ifoc_lgbtq: 'LGBTQ+',
      isize_small: 'Small (<1k)',
      isize_medium: 'Medium',
      isize_large: 'Large',
      irank_activity: 'Instance activity',
      irank_ratio: 'By ratio',
      irank_volume: 'By volume',
      irank_ratio_note: 'by share of active users',
      irank_volume_note: 'by total number of posts',
      // ─── Pohled: Nástroje ───
      ...
      tools_head_category: 'Category',
      tools_head_platform: 'Platform',
      tools_head_forapp: 'For app',
      tools_head_price: 'Price',
      tcat_klient: 'Client',
      tcat_crossposter: 'Crossposter',
      tcat_most: 'Bridge',
      tcat_objevovani: 'Account discovery',
      tcat_migrace: 'Migration',
      tcat_rss: 'RSS / automation',
      tcat_analytika: 'Analytics',
      tplat_android: 'Android',
      tplat_ios: 'iOS',
      tplat_web: 'Web',
      tplat_desktop: 'Desktop',
      tplat_sluzba: 'Web/service',
      tprice_zdarma: 'Free',
      tprice_freemium: 'Freemium',
      tprice_placene: 'Paid',
      tprice_unknown: 'unlisted',
      tools_count: 'tools',
      tools_tab_featured: 'Featured',
      tools_tab_new: 'Recently added',
      tools_own: 'our project',
      tools_official: 'official',
      tools_featured: 'featured',
      tools_for: 'For:',
      tools_added: 'added',
      tools_link_open: 'Open ↗',
      tools_link_appstore: 'App Store ↗',
      tools_link_googleplay: 'Google Play ↗',
      tools_link_fdroid: 'F-Droid ↗',
      tools_link_src: 'Source ↗',
      tools_glossary: 'Glossary →',
      ...
      gloss_more: 'More in the Glossary →',
      gloss_aria: 'Explain term: %s',
      ...
      gloss_head_level: 'Level',
      gloss_head_theme: 'Theme',
      gloss_head_type: 'Type',
      gsort_order: 'For beginners',
      gsort_alpha: 'Alphabetical',
      gsort_theme: 'By theme',
      glevel_zakladni: 'Basic',
      glevel_pokrocile: 'Advanced',
      gtype_pojem: 'Term',
      gtype_postup: 'How-to',
      gtype_zkratka: 'Abbreviation',
      gtheme_ucty: 'Accounts',
      gtheme_federace: 'Federation',
      gtheme_obsah: 'Content',
      gtheme_moderovani: 'Moderation',
      gtheme_soukromi: 'Privacy',
      gtheme_technika: 'Tech',
      gloss_count: 'entries',
      gloss_unit: 'entries',
      gloss_empty: 'No entry matches the filters.',
      gloss_steps: 'Step by step',
      gloss_seealso: 'Related',
      gloss_external: 'Official guide ↗',
      gloss_no_steps: 'Click-by-click steps coming later; the gist is in the description above.',
      // ─── Pohled: Statistiky ───
      ...
      stats_head_period: 'Period',
      stats_head_region: 'Region',
      stats_head_series: 'Apps (series)',
      stats_tab_overview: 'Overview',
      stats_tab_apps: 'By app',
      stats_tab_growth: 'Growth over time',
      stats_tab_czsk: 'CZ/SK slice',
      stats_users: 'Users',
      stats_mau: 'Monthly active',
      stats_servers: 'Servers',
      stats_posts: 'Posts',
      stats_czsk_instances: 'CZ/SK instances',
      stats_total: 'Whole network',
      stats_region_global: 'Global',
      stats_region_czsk: 'CZ-SK',
      stats_period_1y: '1 year',
      stats_period_2y: '2 years',
      ...
      links_head_type: 'Type',
      links_count: 'links',
      ltype_navod: 'Guide',
      ltype_clanek: 'Article',
      ltype_oficialni: 'Official page',
      ltype_video: 'Video',
      links_head_lang: 'Language',
      links_head_theme: 'Theme',
      ltheme_uvod: 'Intro',
      ltheme_navody: 'Guides',
      ltheme_technika: 'Tech',
      ltheme_komunita: 'Community',
      ltheme_data: 'Data',
      lsort_recommended: 'Recommended',
      lsort_alpha: 'Alphabetical',
      lsort_lang: 'By language',
      lfresh_undated: 'undated',
      ...
      search_unit_accounts: 'accounts',
      search_unit_posts: 'posts',
      search_sec_accounts: 'Accounts',
      search_sec_posts: 'Posts',
      search_loading: 'Loading index…',
      search_hint: 'type a query',
      search_zero: 'Nothing found. Try other / broader words.',
      search_results_unit: 'results',
      search_unavail: 'Search index is not available yet.',
      search_open: 'open on Mastodon',
      search_posts_active: 'posts (30 days)',
      ...
      about_menu_howto: 'How to use',
      about_menu_other: 'Other',
      ...
      about_nav_about: 'About Fedík',
      about_nav_search: 'Search',
      about_nav_instance: 'Instances',
      about_nav_apps: 'Apps',
      about_nav_tools: 'Tools',
      about_nav_accounts: 'Accounts',
      about_nav_posts: 'Posts',
      about_nav_links_howto: 'Links',
      about_nav_tech: 'Technical details',
      about_nav_author: 'About the author',
      about_nav_faq: 'FAQ',
      about_nav_faq_novacci: 'For beginners',
      about_nav_stats: 'Statistics',
      // ─── O Fedíku — Pro začátečníky (FAQ + tipy) ───
      faqn_head: 'For beginners',
      faqn_q_head: 'Common questions',
      faqn_tips_head: 'Mastodon tips',
      tip1_t: 'Mind your post’s language',
      tip1_d: 'Mastodon sets a language for every post. A Czech post accidentally sent as English won’t show in the Czech federated timeline (and vice versa) — check before posting.',
      tip2_t: 'Fill in your profile right away',
      tip2_d: 'Avatar, a short bio and a few first posts. Empty accounts look inactive or spammy — people won’t follow them and admins sometimes prune them.',
      tip3_t: 'Quoting instead of boosting',
      tip3_d: 'Mastodon has no native quote-repost. To comment on a post, write a new one like “Ad @name@server: …” and add a link to the original.',
      tip4_t: 'You can read without an account',
      tip4_d: 'Don’t want to sign up and just want to read? Add .rss to a profile (https://server/@name.rss) and drop it into an RSS reader.',
      tip5_t: 'Mute for peace and quiet',
      tip5_d: 'Timeline too noisy? Mute the accounts or hashtags you don’t care about — the federated and home timelines get readable fast.',
      tip6_t: 'Lists to tidy your home feed',
      tip6_d: 'Sort who you follow into lists and hide the less important ones from your home feed (“Hide members from Home”). Read specific topics — sport, music — when you want.',
      tip7_t: 'Careful editing a running poll',
      tip7_d: 'If you edit a poll that’s already running, it resets and starts over. So check it carefully before posting.',
      tip8_t: 'Customize the look',
      tip8_d: 'Don’t like the web client? Try an alternative (Elk, Phanpy) or add the Stylish browser extension with a theme like TangerineUI.',
