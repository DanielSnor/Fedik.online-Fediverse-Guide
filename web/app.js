...
(function () {
  ...
  var STRINGS = {
    cs: {
      ...
      apps_head_type: 'Typ obsahu', apps_head_equiv: 'Obdoba sítě', apps_head_czech: 'Čeština v rozhraní',
      ...
      tip3_t: 'Citování místo boostu', tip3_d: 'Mastodon historicky neměl nativní citace (quote posts), takže se používal workaround s novým příspěvkem a odkazem. V novějších verzích (např. 4.5) už ale citace existují – pokud je instance a autor povolí.',
      ...
      about_nav_tech: 'Technické řešení', about_nav_author: 'O autorovi', about_nav_faq: 'FAQ', about_nav_faq_novacci: 'Pro začátečníky', about_nav_stats: 'Statistikami',
