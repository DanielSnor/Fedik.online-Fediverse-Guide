...
(function () {
  ...
  var STRINGS = {
    cs: {
      ...
      start_menu_intro1: 'Fediverse je svět propojený nezávislými sociálními sítěmi. Není to pouze „velká platforma“ ovládaná jedinou firmou – systém tvoří tisíce serverů, které navzájem komunikují.',
      start_menu_intro2: 'Je to obrovský prostor, téměř jako ten mezihvězdný, a aby ses v něm neztratil, nech se námi navigovat – provést tě následujícími kroky, které ti pomohou přistát přesně na té planetě – aplikaci, kde si to přeješ, a založit tam svou základnu – účet.',
      start_step1: 'Co ten Fediverse vlastně je?',
    ...
    en: {
      ...
      start_menu_intro1: 'The Fediverse is a world of independent, interconnected social networks. It’s not one “big platform” run by a single company – it’s built from thousands of servers that talk to each other.',
      start_menu_intro2: 'It’s a vast space, almost like interstellar space – and so you don’t get lost in it, let us navigate you through the steps that help you land on exactly the planet – the app – you want, and set up your base – your account – there.',
      start_step1: 'What is the Fediverse, really?',
