...
(function () {
  ...
  var STRINGS = {
    cs: {
      ...
      cat_apps_p1: 'Aplikace jsou lodě Fediverse — software, kterým do něj vstoupíš. Každá je dobrá na něco jiného: mikroblog, fotky, video, fórum, blog. Všechny spolu ale umí mluvit, takže ať si vybereš cokoli, neztratíš se ze sítě.',
      ...
      cat_instances_p2: 'Ukazujeme české a slovenské Mastodon instance z katalogu Sloník.online — u každé velikost, aktivita, stav registrace a kolik z ní účtů máme v katalogu. Řadíme podle podílu aktivních uživatelů; filtruj přes Top 10/50, poměrem nebo objemem a koukni na žebříček „pro začátečníky".',
      ...
      cat_tools_p2: 'Klienti jsou z FediDB, zbytek je kurátorský výběr živých nástrojů. Filtruj podle kategorie (klient, most, migrace, RSS…), platformy (Android, iOS, web, desktop), ceny a hlavně podle aplikace — ať vidíš jen to, co se hodí k tvé síti.',
      ...
      cat_glossary_p2: 'Najdeš tu hesla od základních pojmů po praktické postupy, vysvětlená česky a bez žargonu. Hledej podle názvu nebo proklikni z výrazů v průvodci, které na Slovníček odkazují.',
      ...
      cat_links_head: 'Odkazy — majáky dál do vesmíru',
      cat_links_p1: 'Odkazy jsou majáky dál do vesmíru — když ti Fedík nestačí a chceš číst, sledovat dění nebo se zapojit hlouběji. Rozcestník ven za hranice tohohle průvodce.',
      cat_links_p2: 'Kurátorovaný výběr českých i zahraničních zdrojů o Fediverse: weby, blogy, komunity a další průvodci. Vybíráme jen živé a smysluplné odkazy, ne všechno, co existuje.',
