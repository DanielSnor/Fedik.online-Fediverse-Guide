...
(function () {
  ...
  var STRINGS = {
    cs: {
      ...
      step3_label: 'Vyber si planetu (instanci)',
      step4_label: 'Postav si základnu (založ účet)',
      step5_label: 'První den na základně',
      step6_label: 'Sestav posádku (najdi lidi)',
      step1_desc: 'Síť propojených serverů — jeden účet, žádné reklamy, žádný algoritmus.',
      step2_desc: 'Podle toho, co chceš dělat: mikroblog, fotky, video, fórum…',
      step3_desc: 'Server, kde budeš mít účet. Měnit ho jde kdykoli, sledující jdou s tebou.',
      step4_desc: 'Pár minut: e-mail, potvrzení, někdy krátké schválení.',
      step5_desc: 'Šest věcí, co udělat hned, ať tě to chytne.',
      step6_desc: 'Ať doma není prázdno — odkud nabrat první účty.',
      step2_sub: 'Vyber síť, kterou znáš, nebo typ obsahu — ukážu ti odpovídající loď (aplikaci). Tlačítko „Začít“ tě pošle dál: u hlavních aplikací rovnou na výběr planety (instance), u ostatních na jejich oficiální stránku.',
      ...
      fday_intro: 'Projdi je popořadě a Fediverse tě chytne hned první den.',
    ...
    en: {
      ...
      step3_label: 'Pick your planet (an instance)',
      ...
      step1_desc: 'A network of connected servers — one account, no ads, no algorithm.',
      step2_desc: 'Based on what you want to do: microblogging, photos, video, forums…',
      step3_desc: 'The server your account lives on. Change it anytime; your followers come with you.',
      step4_desc: 'A few minutes: email, confirmation, sometimes a short approval wait.',
      step5_desc: 'Six things to do right away so it clicks.',
      step6_desc: 'So your home feed isn’t empty — where to grab your first accounts.',
      step2_sub: 'Pick a network you know, or a type of content — I’ll show you the matching ship (app). “Start” takes you onward: for the main apps straight to picking a planet (instance), for the rest to their official page.',
      ...
      fday_intro: 'Go through them in order and the Fediverse will click on day one.',
